...
const Home=()=>{
    return(<div className="bg-gray-50">
        ...
        <Navbar></Navbar>
        <div className="font-bold text-2xl w-40 pt-20">Workspace that inspire</div>
        ...
        <div className="flex flex-row justify-evenly py-10">
            ...
            <div className="flex flex-col space-y-10 w-1/2 h-auto">
        ...
        <div className="w-1/3 p-10 bg-white shadow-2xl">
                <div className="flex flex-col space-y-10 text-2xl font-bold w-1/2 "> Fast moving consumer goods</div>
                <div className="py-5">
