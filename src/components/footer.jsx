const Footer = () => {
  return (
   <footer className="w-full  bg-current h-auto md:h-80">
     <div className="flex flex-col space-y-10 md:space-y-20 p-6 md:px-40" >
      <div className="flex flex-row justify-between">
        <div className="font-semibold text-white">UPRISING</div>
        <div className="flex flex-row space-x-2 md:space-x-4 gap-2 md:gap-5">
      ...
      <div className="grid grid-rows-3 md:grid-cols-3 gap-5 text-white">
            ...
            <div className="space-y-1">
                ...
                <div>
                    <input className="p-3 bg-white" type="text" placeholder="Your Email"/>
                    <button className="p-3 bg-blue-500 ">Subscribe</button>
                </div>
