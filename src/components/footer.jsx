const Footer = () => {
  return (
   <div className="w-full bg-current ">
     <div className="flex flex-col space-y-20 px-40 py-6" >
      <div className="flex flex-row justify-between ">
        <div className="font-semibold text-white">UPRISING</div>
        <div className="flex flex-row space-x-4">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256"><path fill="#FBBB05" d="M64 58.149c35.328 0 64 28.672 64 64V128H5.851C2.633 128 0 125.367 0 122.149c0-35.328 28.672-64 64-64Z"/><path fill="#E94335" d="M197.851 64c0 35.328-28.672 64-64 64H128V5.851C128 2.633 130.633 0 133.851 0c35.328 0 64 28.672 64 64Z"/><path fill="#4285F4" d="M192 197.851c-35.328 0-64-28.672-64-64V128h122.149c3.218 0 5.851 2.633 5.851 5.851c0 35.328-28.672 64-64 64Z"/><path fill="#0F9D58" d="M58.149 192c0-35.328 28.672-64 64-64H128v122.149c0 3.218-2.633 5.851-5.851 5.851c-35.328 0-64-28.672-64-64Z"/></svg>
            </div>
            <div>
