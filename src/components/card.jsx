...
const Cards = () => {
  return (
    ...
    <h1 className='w-full flex justify-center text-3xl p-5 font-bold text-black'>Why-us?</h1>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-4 gap-6'>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <div className='text-center font-medium'>
                  <p className='py-2 border-b mx-8 mt-8'>We have diverse team working in trending technologies like Artificial Intelligence, Deep learning, 3D modelling, UI/UX, Web development, etc</p>
