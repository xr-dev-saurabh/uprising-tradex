  ...
  return (
    ...
    <div className='justify-center flex'>
      ...
      <div className=" flex flex-col justify-between">
        ...
        <a href="#contact" rel="noopener noreferrer" className='bg-green-500 text-white px-2 py-1 text-[14px] md:px-3 md:py-2 rounded-lg self-end mt-4 uppercase hover:bg-green-400'>
