...
export default function ProductsRow() {
    return (
        <div className='p-5 md:p-24 flex flex-wrap justify-around gap-10' id='products'>
            ...
            <Card img={Wafer} title="Wafer Biscuits" disc="Offering you a complete choice of products which include Chocolate Wafer Biscuits, Orange Wafer Biscuits, Straberry Wafer Biscuits and Vanilla Wafer Biscuits" key={4} />
            <Card img={FlavouredPeanuts} title="FLAVOURED PEANUTS" disc="Pioneers in the industry, we offer Flavored Black Pepper Peanuts, Hing Jeera Flavored Peanuts, Nimbu Pudina Flavored Peanuts and Spicy Flavored Peanuts from India." key={5} />
            <Card img={DryFruits} title="DRYFRUITS" disc="Prominent & Leading Manufacturer from Surat, we offer Paan Flavoured Raisins, Cashew Nuts, Mixed Fruit Flavoured Raisins, Mango Flavoured Raisins and Udad Papad." key={6} />
            <Card img={Commoditiies} title="COMMODITIES" disc="Offering you a complete choice of products which include Sesame seeds ( Til ), Toor Whole ( Pigeon Peas ) and Chickpeas ( Chana whole )." key={7} />
        </div>
    )
}
