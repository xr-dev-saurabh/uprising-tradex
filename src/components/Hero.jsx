    ...
    return (
        <div className="flex items-center bg-white w-full h-screen bg-cover">
            ...
            <div className="flex flex-col items-center  px-4 sm:px-6 lg:px-8 w-full ml-10 z-10">
                ...
                <h1 className=" tracking-wide text-gray-800 text-4xl md:text-8xl" style={{fontFamily: "Bebas Neue"}}>
                ...
                <button className='group border text-gray-800 border-black px-3 py-2 mt-6 font-semibold tracking-wider mx-auto text-[27px] bg-white flex items-center'>
                    <FaRegCirclePlay  />
