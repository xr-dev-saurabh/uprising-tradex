    ...
    <div className="h-screen w-full bg-[#f8f9fb] items-center  justify-center overflow-hidden">
      <SvgMask
        revealText={
          ...
          <div className="flex flex-col items-center text-slate-800 px-4 sm:px-6 lg:px-8 w-full">
          <h1 className=" text-gray-800 text-3xl px-[20px] md:text-7xl text-center" style={{fontFamily: "Bebas Neue"}}>
      ...
      <h1 className=" text-white text-3xl px-[20px] md:text-7xl text-center" style={{fontFamily: "Bebas Neue"}}>
          WORKPLACE THAT INSPIRE
      </h1>
      <div className="mt-3 space-y-4 sm:space-y-8">
          <p className="text-white text-center text-[16px] md:text-xl px-[20px]" style={{lineHeight: "1.5em"}}>
              We work for people and make their dreams come true.
          </p>
      </div>
      <a href="#Services" rel="noopener noreferrer">
