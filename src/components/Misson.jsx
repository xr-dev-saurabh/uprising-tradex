...
export default function Misson() {
    return (
        <>
            <div
                className='h-[500px] bg-no-repeat relative bg-center my-20 flex justify-between px-[10%]  before:rounded-full before:w-20 before:scale-[2.8] before:py-5 before:absolute before:border-t-[40px] before:border-[#D5FAFC] before:bottom-[-90px] before:left-[25%]
