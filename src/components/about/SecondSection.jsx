...
export default function SecondSection() {
    return (
        <div className='lg:flex w-full flex-row-reverse p-5 lg:p-24 justify-between bg-[#f8f9fb]'>
            <div className='lg:w-[20%] w-full flex justify-end '>
                <img src={Fancy2} alt="" className='mx-auto lg:mx-0 mb-5 ' />
            </div>
            <p className='text-lg text-justify lg:w-[75%]'>
