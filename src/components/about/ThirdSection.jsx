                ...
                <div className='flex flex-col items-center  lg:flex-row justify-between '>
                    ...
                    <div className='lg:w-[60%]'>
                        ...
                        <p className='text-lg text-justify'>
                            ...
                            <br />
                            <br />
                            In addition, our AR filter developers create engaging experiences for social media platforms, while our web developers and UI/UX designers work tirelessly to deliver seamless and intuitive digital experiences for our customers. Together, our team collaborates seamlessly to deliver innovative solutions that exceed expectations and drive business groth.
                        </p>
                    </div>
                </div>
            </div>
