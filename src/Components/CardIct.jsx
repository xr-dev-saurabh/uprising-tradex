    ...
    <div className="justify-center flex items-center md:mt-12 mt-8  w-full md:flex-row ">
      <div className="lg:w-[90%] flex flex-wrap justify-center gap-12 items-center md:p-5 mb-5 md:justify-evenly">
        ...
        <div className="bg-white rounded-lg shadow-lg w-[90%] md:max-w-md md:p-8 p-4">
          ...
          >
            {" "}
            <a href="https://twitter.com/reealtech" target="_blank" rel="noopener noreferrer">
            <FaXTwitter
              size={30}
              className=" transition-colors duration-300 ease-in-out hover:text-gray-500"
            />
            </a>
            <a href="https://www.facebook.com/vamverse" target="_blank" rel="noopener noreferrer">
            <FaFacebook
              size={30}
              className=" transition-colors duration-300 ease-in-out hover:text-gray-500"
            />
            </a>
            <a href="https://www.linkedin.com/company/reealtech/" target="_blank" rel="noopener noreferrer">
            <FaLinkedin
              size={30}
              className=" transition-colors duration-300 ease-in-out hover:text-gray-500"
            />
        ...
        <div className="bg-white rounded-lg shadow-lg md:p-8 p-4 w-[90%] md:max-w-md">
          ...
          <a href="https://twitter.com/uprisingtradex" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.indiamart.com/uprising-tradex-llp/aboutus.html" target="_blank" rel="noopener noreferrer">
            <FaInstagram
              size={30}
              className="transition-colors duration-300 ease-in-out hover:text-gray-500"
            />
